    ...
    class ProjectTile {
        ...
        draw(context) {
            context.drawImage(this.image,
                this.frameX * this.width, 0, this.width, this.height, this.x, this.y,
    ...
    class Particle {
        ...
        draw(context) {
            ...
            context.drawImage(this.image, this.frameX * this.spriteSize,
                this.frameY * this.spriteSize, this.spriteSize, this.spriteSize, this.size * -0.5, this.size * -0.5, this.size, this.size);
            context.restore();
        }
    }
    class Player {
        ...
        update(deltaTime) {
            ...
            this.projecttiles.forEach(projecttile => {
                projecttile.update(deltaTime);
            });
            this.projecttiles = this.projecttiles.filter(projecttile => !projecttile.markedForDeletion);
            //Sprite animation
            if (this.frameX < this.maxFrame) {
                this.frameX++;
            } else {
        ...
        draw(context) {
            ...
            if (this.game.gameOver) {
                ...
                if (this.game.score > this.game.winningScore) {
                    ...
                    message1 = 'BLAZES!';
                    message2 = 'GET MY REPAIR KIT AND TRY AGAIN NEXT TIME!';
                }
    ...
    class Game {
        ...
        update(deltaTime) {
            ...
            this.enemies.forEach(enemy => {
                ...
                this.Player.projecttiles.forEach(projecttile => {
                    if (this.checkCollision(projecttile, enemy)) {
                        enemy.lives--;
                        projecttile.markedForDeletion = true;
                        this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5,
                            enemy.y + enemy.height * 0.5));
                        this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5,
                            enemy.y + enemy.height * 0.5));
                        if (enemy.lives <= 0) {
                            ...
                            if (enemy.type === 'hive') {
                                for (let i = 0; i < 5; i++) {
                                    this.enemies.push(new Drone(this, enemy.x + Math.random() * enemy.width * 0.5,
